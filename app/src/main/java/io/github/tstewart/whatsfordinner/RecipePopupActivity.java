...
public class RecipePopupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNewRecipe.setOnClickListener(this::onNewRecipeButtonClicked);

        Button btnConfirmRecipe = findViewById(R.id.btnRecipeSuccess);
        btnConfirmRecipe.setOnClickListener(this::onConfirmRecipeClicked);

    }

    private void onConfirmRecipeClicked(View view) {
    ...
    private void onNewRecipeButtonClicked(View view) {
        this.finish();
    }
}
